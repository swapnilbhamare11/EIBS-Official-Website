                    ...
                    <div class="service-details__left">
                        <div class="service-details__service">
                            ...
                            <ul class="service-details__service-list list-unstyled">
                                <li><a href="product-development.php">Product development <span class="fa fa-long-arrow-alt-right"></span></a></li>

                                <li><a href="ui-ux-designing.php">UI/UX designing <span class="fa fa-long-arrow-alt-right"></span></a></li>

                                <li><a href="digital-marketing.php">Digital marketing <span class="fa fa-long-arrow-alt-right"></span></a></li>

                                <li><a href="content-management.php">Content management <span class="fa fa-long-arrow-alt-right"></span></a></li>

                                <li class="active"><a href="data-analysis.php">Data analysis <span class="fa fa-long-arrow-alt-right"></span></a></li>
                            </ul>
                        </div>
                        <div class="service-details__need-help">
                         ...
                         <h2 class="service-details__need-help-title">Easy solutions <br> to your tech <br> problem</h2>
                     ...
                     <div class="service-details__download">
                        <a href="about.php" class="thm-btn service-details__download-btn">Download our flyer</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-8 col-lg-7">
                <div class="service-details__right">
                    ...
                    <div class="service-details__content">
                        <h3 class="service-details__content-title">Data analysis</h3>
                        ...
                        <p class="service-details__text-2">When an unknown printer took a simply free galley of type and scrambled it to make a type specimen book.</p>
