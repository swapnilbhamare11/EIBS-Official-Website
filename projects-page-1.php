                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                            ...
                            <div class="project-one__single">
                                ...
                                <div class="project-one__content">
                                    ...
                                    <h3 class="project-one__title"><a href="project-details.php">Cloud migration saves <br> money & protect</a></h3>
                                    <p class="project-one__text">When an unknown printer took a<br> galley to and type book.</p>
                        ...
                        <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                            ...
                            <div class="project-one__single project-one__single-two">
                                ...
                                <div class="project-one__content">
                                    ...
                                    <h3 class="project-one__title"><a href="project-details.php">Perfect solution that your <br> business demands</a></h3>
                                    <p class="project-one__text">When an unknown printer took a<br> galley to and type book.</p>
                                    <a href="project-details.php" class="thm-btn project-one__btn">View our project</a>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                            ...
                            <div class="project-one__single project-one__single-three">
                                ...
                                <div class="project-one__content">
                                    ...
                                    <h3 class="project-one__title"><a href="project-details.php">Trusted by The world's best <br> organizations</a></h3>
                                    <p class="project-one__text">When an unknown printer took a<br> galley to and type book.</p>
                                    <a href="project-details.php" class="thm-btn project-one__btn">View our project</a>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="400ms">
                            <!--Project One Single-->
                            <div class="project-one__single project-one__single-four">
                                <div class="project-one__img">
                                    <img src="assets/images/project/project-1-4.jpg" alt="">
                                    <a href="project-details.php">
                                        <img src="assets/images/icon/project-1-icon-4.png" alt="">
                                    </a>
                                </div>
                                <div class="project-one__content">
                                    <span class="project-one__sub-title">Design</span>
                                    <h3 class="project-one__title"><a href="project-details.php">It has survived not only five <br> but also the leap</a></h3>
                                    <p class="project-one__text">When an unknown printer took a<br> galley to and type book.</p>
                                    <a href="project-details.php" class="thm-btn project-one__btn">View our project</a>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="500ms">
                            <!--Project One Single-->
                            <div class="project-one__single project-one__single-five">
                                <div class="project-one__img">
                                    <img src="assets/images/project/project-1-5.jpg" alt="">
                                    <a href="project-details.php">
                                        <img src="assets/images/icon/project-1-icon-5.png" alt="">
                                    </a>
                                </div>
                                <div class="project-one__content">
                                    <span class="project-one__sub-title">Technology</span>
                                    <h3 class="project-one__title"><a href="project-details.php">Take a look at our round up <br> ofthe best</a></h3>
                                    <p class="project-one__text">When an unknown printer took a<br> galley to and type book.</p>
                                    <a href="project-details.php" class="thm-btn project-one__btn">View our project</a>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="600ms">
                            <!--Project One Single-->
                            <div class="project-one__single project-one__single-six">
                                <div class="project-one__img">
                                    <img src="assets/images/project/project-1-6.jpg" alt="">
                                    <a href="project-details.php">
                                        <img src="assets/images/icon/project-1-icon-6.png" alt="">
                                    </a>
                                </div>
                                <div class="project-one__content">
                                    <span class="project-one__sub-title">Ideas</span>
                                    <h3 class="project-one__title"><a href="project-details.php">Lorem Ipsum has been <br> standard dummy</a></h3>
                                    <p class="project-one__text">When an unknown printer took a<br> galley to and type book.</p>
                                    <a href="project-details.php" class="thm-btn project-one__btn">View our project</a>
                                </div>
                            </div>
