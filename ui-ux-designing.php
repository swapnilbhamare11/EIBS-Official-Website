                    ...
                    <div class="service-details__left">
                        <div class="service-details__service">
                            ...
                            <ul class="service-details__service-list list-unstyled">
                                <li><a href="product-development.php">Product development <span
                                    class="fa fa-long-arrow-alt-right"></span></a></li>

                                    <li class="active"><a href="ui-ux-designing.php">UI/UX designing <span
                                        class="fa fa-long-arrow-alt-right"></span></a></li>

                                        <li><a href="digital-marketing.php">Digital marketing <span
                                            class="fa fa-long-arrow-alt-right"></span></a></li>

                                            <li><a href="content-management.php">Content management <span
                                                class="fa fa-long-arrow-alt-right"></span></a></li>

                                                <li><a href="data-analysis.php">Data analysis <span
                                                    class="fa fa-long-arrow-alt-right"></span></a></li>
                                                </ul>
                                            </div>
                                            ...
                                            <h2 class="service-details__need-help-title">Easy solutions <br> to your tech <br>
                                            problem</h2>
                                        ...
                                        <div class="service-details__download">
                                            <a href="about.php" class="thm-btn service-details__download-btn">Download our
                                            flyer</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-8 col-lg-7">
                                    <div class="service-details__right">
                                        ...
                                        <div class="service-details__content">
                                            ...
                                            <p class="service-details__text-2">When an unknown printer grg took a simply free galley of
                                            type and scrambled it to make a type specimen book.</p>
                                        ...
                                        <ul class="list-unstyled service-details__points">
                                            <li>
                                                ...
                                                <p class="service-details__points-text">Lorem ipsum is simply free <br> text used by
                                                refring.</p>
                                            </li>
                                            <li>
                                                <div class="service-details__points-icon">
