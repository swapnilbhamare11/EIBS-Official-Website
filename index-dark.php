				...
				<div class="feature-one__single">
					<div class="feature-one__img">
						...
						<div class="feature-one__title-box">
							<h3 class="feature-one__title"><a href="about.php">Manage IT services</a></h3>
						</div>
						<div class="feature-one__hover-content">
							<div class="feature-one__icon">
								<span class="icon-system"></span>
							</div>
							<h3 class="feature-one__hover-title"><a href="about.php">Manage IT services</a>
							</h3>
			...
			<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
				...
				<div class="feature-one__single">
					<div class="feature-one__img">
						...
						<div class="feature-one__title-box">
							<h3 class="feature-one__title"><a href="about.php">Cyber security</a></h3>
						</div>
						<div class="feature-one__hover-content">
							<div class="feature-one__icon">
								<span class="icon-cyber"></span>
							</div>
							<h3 class="feature-one__hover-title"><a href="about.php">Cyber securitys</a></h3>
							<p class="feature-one__hover-text">There are many lipsum of in pass sages of
							available some.</p>
							<div class="feature-one__learn-more">
								<a href="about.php">Learn more<i class="fa fa-long-arrow-alt-right"></i></a>
			...
			<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
				...
				<div class="feature-one__single">
					<div class="feature-one__img">
						...
						<div class="feature-one__title-box">
							<h3 class="feature-one__title"><a href="about.php">Digital experience</a></h3>
						</div>
						<div class="feature-one__hover-content">
							<div class="feature-one__icon">
								<span class="icon-application"></span>
							</div>
							<h3 class="feature-one__hover-title"><a href="about.php">Digital experience</a>
							</h3>
							<p class="feature-one__hover-text">There are many lipsum of in pass sages of
							available some.</p>
							<div class="feature-one__learn-more">
		...
		<div class="row">
			<div class="col-xl-6">
				...
				<div class="get-to-know__img-box">
					...
					<div class="get-to-know-shape-1"><img src="assets/images/shapes/get-to-know-shape-1.png"
						alt=""></div>
					</div>
				</div>
			</div>
			<div class="col-xl-6">
				<div class="get-to-know__right">
					...
					<a href="about.php" class="get-to-know__btn thm-btn">Discover more</a>
				</div>
			</div>
		</div>
	</div>
			...
			<ul class="list-unstyled services-one__list">
				<li class="services-one__single">
					<div class="services-one__content">
						...
						<h3 class="services-one__title"><a href="product-development.php">Product <br>
						development</a></h3>
				...
				<li class="services-one__single">
					<div class="services-one__content">
						...
						<h3 class="services-one__title"><a href="ui-ux-designing.php">UI/UX <br> designing</a>
						</h3>
						<p class="services-one__text">Lorem ipsum dolor <br> sit amet do.</p>
					</div>
				</li>
				<li class="services-one__single">
					<div class="services-one__content">
						...
						<h3 class="services-one__title"><a href="digital-marketing.php">Digital <br>
						marketing</a></h3>
						<p class="services-one__text">Lorem ipsum dolor <br> sit amet do.</p>
					</div>
				</li>
				<li class="services-one__single">
					<div class="services-one__content">
						...
						<h3 class="services-one__title"><a href="content-management.php">Content <br>
						management</a></h3>
						<p class="services-one__text">Lorem ipsum dolor <br> sit amet do.</p>
					</div>
				</li>
				<li class="services-one__single">
					<div class="services-one__content">
						...
						<h3 class="services-one__title"><a href="data-analysis.php">Data <br> analysis</a></h3>
						<p class="services-one__text">Lorem ipsum dolor <br> sit amet do.</p>
					</div>
				</li>
			</ul>
		...
		<div class="container">
				...
				<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
					...
					<div class="project-one__single">
						...
						<div class="project-one__content">
							...
							<h3 class="project-one__title"><a href="project-details.php">Cloud migration saves
								<br> money & protect</a></h3>
								<p class="project-one__text">When an unknown printer took a<br> galley to and type
								book.</p>
								<a href="project-details.php" class="thm-btn project-one__btn">View our project</a>
							</div>
						</div>
					</div>
					<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
						...
						<div class="project-one__single project-one__single-two">
							...
							<div class="project-one__content">
								...
								<h3 class="project-one__title"><a href="project-details.php">Perfect solution that
						...
						<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
							...
							<div class="project-one__single project-one__single-three">
								...
								<div class="project-one__content">
									...
									<h3 class="project-one__title"><a href="project-details.php">Trusted by The world's
					...
					<div class="trusted-source__inner wow fadeInUp" data-wow-delay="300ms">
						<div class="trusted-source__left">
							...
							<div class="trusted-source__icon">
								<img src="assets/images/icon/trusted-source-icon.png" alt="">
							</div>
						</div>
			...
			<section class="brand-one">
				<div class="container">
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<img src="assets/images/dark/brand-d-1-1.png" alt="">
						</div><!-- /.swiper-slide -->
						<div class="swiper-slide">
							<img src="assets/images/dark/brand-d-1-1.png" alt="">
						</div><!-- /.swiper-slide -->
