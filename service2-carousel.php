			...
			<div class="item">
				...
				<div class="feature-one__single">
					<div class="feature-one__img">
						...
						<div class="feature-one__title-box">
							<h3 class="feature-one__title"><a href="about.php">Product development</a></h3>
						</div>
						<div class="feature-one__hover-content">
							<div class="feature-one__icon">
								<span class="icon-coding"></span>
							</div>
							<h3 class="feature-one__hover-title"><a href="about.php">Product development</a>
							</h3>
							<p class="feature-one__hover-text">There are many lipsum of in pass sages of
							available some.</p>
							<div class="feature-one__learn-more">
			...
			<div class="item">
				...
				<div class="feature-one__single">
					<div class="feature-one__img">
						...
						<div class="feature-one__title-box">
							<h3 class="feature-one__title"><a href="about.php">UI/UX designings</a></h3>
						</div>
						<div class="feature-one__hover-content">
							<div class="feature-one__icon">
								<span class="icon-design-thinking"></span>
							</div>
							<h3 class="feature-one__hover-title"><a href="about.php">UI/UX designings</a></h3>
							<p class="feature-one__hover-text">There are many lipsum of in pass sages of
							available some.</p>
							<div class="feature-one__learn-more">
								<a href="about.php">Learn more<i class="fa fa-long-arrow-alt-right"></i></a>
			...
			<div class="item">
				...
				<div class="feature-one__single">
					<div class="feature-one__img">
						...
						<div class="feature-one__title-box">
							<h3 class="feature-one__title"><a href="about.php">Content
							management</a></h3>
						</div>
						<div class="feature-one__hover-content">
							<div class="feature-one__icon">
							...
							<h3 class="feature-one__hover-title"><a href="about.php">Content
							management</a>
						</h3>
						<p class="feature-one__hover-text">There are many lipsum of in pass sages of
						available some.</p>
