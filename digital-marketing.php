    ...
    <div class="container">
        <div class="page-header__inner">
            <ul class="thm-breadcrumb list-unstyled">
                ...
                <li><span>/</span></li>
                <li class="active">Degital Marketing</li>
            </ul>
                ...
                <div class="service-details__left">
                    <div class="service-details__service">
                        ...
                        <ul class="service-details__service-list list-unstyled">
                            ...
                            <li class="active"><a href="digital-marketing.php">Digital marketing <span class="fa fa-long-arrow-alt-right"></span></a></li>

                            <li><a href="content-management.php">Content management <span class="fa fa-long-arrow-alt-right"></span></a></li>

                            <li><a href="data-analysis.php">Data analysis <span class="fa fa-long-arrow-alt-right"></span></a></li>
                        </ul>
                    </div>
