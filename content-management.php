                        ...
                        <div class="service-details__service">
                            ...
                            <ul class="service-details__service-list list-unstyled">
                                <li><a href="product-development.php">Product development <span
                                    ...
                                    <li><a href="ui-ux-designing.php">UI/UX designing <span
                                        class="fa fa-long-arrow-alt-right"></span></a></li>

                                        <li><a href="digital-marketing.php">Digital marketing <span
                                            class="fa fa-long-arrow-alt-right"></span></a></li>

                                            <li class="active"><a href="content-management.php">Content management <span
                                                class="fa fa-long-arrow-alt-right"></span></a></li>
                                ...
                                <div class="col-xl-8 col-lg-7">
                                    <div class="service-details__right">
                                        ...
                                        <div class="service-details__content">
                                            <h3 class="service-details__content-title">Content management</h3>
