...
?>
		<!-- <div class="stricky-header stricked-menu main-menu">
			<div class="sticky-header__content"></div></div> --><!-- /.sticky-header__content -->
	<!-- /.stricky-header -->
					...
					<div class="col-xl-8 col-lg-7">
						<div class="blog-sideabr__left">
								...
								<div class="blog-sidebar__single">
									...
									<div class="blog-sidebar__content-box">
										<ul class="list-unstyled blog-sidebar__meta">
											...
											<li><a href="blog-details.php"><i class="far fa-user-circle"></i> by
													Layerdrops</a></li>
										</ul>
										...
										<div class="blog-sidebar__bottom">
											<a href="blog-details.php" class="blog-sidebar__read-more">Learn more</a>
										</div>
									</div>
								</div>
								<!--Blog Sidebar Single-->
							...
							<div class="blog-sidebar__delivering-services">
								...
								<h3 class="blog-sidebar__delivering-services-title"><a href="blog-details.php">We’re
										delivering the best IT services</a></h3>
							</div>
							<div class="col-lg-12">
						...
						<div class="sidebar">
								...
								<ul class="sidebar__post-list list-unstyled">
									<li>
										...
										<div class="sidebar__post-content">
											<h3>
												<span class="sidebar__post-content-meta"><i class="far fa-clock"></i> 8
													Jan, 2022</span>
									...
									<li>
										...
										<div class="sidebar__post-content">
											<h3>
												<span class="sidebar__post-content-meta"><i class="far fa-clock"></i> 8
													Jan, 2022</span>
												<a href="blog-details.php">Bring to the table win-win survival
													strategies</a>
											</h3>
										</div>
									</li>
							...
							<div class="sidebar__single sidebar__category">
								...
								<ul class="sidebar__category-list list-unstyled">
									<li><a href="blog-details.php">Technology <span
												class="fa fa-long-arrow-alt-right"></span></a></li>
									<li class="active"><a href="blog-details.php">Software <span
												class="fa fa-long-arrow-alt-right"></span></a></li>
									<li><a href="blog-details.php">Innovations <span
												class="fa fa-long-arrow-alt-right"></span></a></li>
									<li><a href="blog-details.php">Development <span
												class="fa fa-long-arrow-alt-right"></span></a></li>
									<li><a href="blog-details.php">Web Design <span
												class="fa fa-long-arrow-alt-right"></span></a></li>
								</ul>
							</div>
